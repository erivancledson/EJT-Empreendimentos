...
public class TelaCadastroEletricista {


	public JFrame frmCadastroEletricista;
	 ...
	 */
	public TelaCadastroEletricista() {
		initialize();
	}
	...
	private void initialize() {
		frmCadastroEletricista = new JFrame();
		frmCadastroEletricista.setType(Type.UTILITY);
		frmCadastroEletricista.getContentPane().setBackground(Color.WHITE);
		frmCadastroEletricista.setTitle("CADASTRO ELETRICISTA");
		frmCadastroEletricista.setBounds(100, 100, 630, 417);
		frmCadastroEletricista.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		frmCadastroEletricista.getContentPane().setLayout(null);
		
		frmCadastroEletricista.setUndecorated(true);
	    frmCadastroEletricista.setLocationRelativeTo(null); 
		
		JPanel panelBotoes = new JPanel();
		panelBotoes.setBackground(Color.WHITE);
		panelBotoes.setBounds(10, 337, 594, 41);
		frmCadastroEletricista.getContentPane().add(panelBotoes);
		panelBotoes.setLayout(null);
		
		JButton btnLimpar = new JButton("LIMPAR");
		btnLimpar.setForeground(SystemColor.activeCaption);
		btnLimpar.setBackground(SystemColor.inactiveCaptionBorder);
		btnLimpar.setIcon(new ImageIcon(TelaCadastroEletricista.class.getResource("/EJT/imagens/buttonLimpar.png")));
		...
		btnCancelar.setIcon(new ImageIcon(TelaCadastroEletricista.class.getResource("/EJT/imagens/buttonCancelar.png")));
		btnCancelar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {

				frmCadastroEletricista.dispose();
		...
		btnCadastrar.setIcon(new ImageIcon(TelaCadastroEletricista.class.getResource("/EJT/imagens/buttonComfirma.png")));
		...
		frmCadastroEletricista.getContentPane().add(panel);
		...
		JLabel lblDadosPessoais = new JLabel("Cadastro Eletricista");
		lblDadosPessoais.setBounds(241, 11, 165, 14);
		frmCadastroEletricista.getContentPane().add(lblDadosPessoais);
		...
		lblSair.setIcon(new ImageIcon(TelaCadastroEletricista.class.getResource("/EJT/imagens/botao_fechar.png")));
		lblSair.setBounds(564, 0, 30, 25);
		panel.add(lblSair);
	...
	private void cadastrarEletricista() throws Exception {
		...
		Eletricista eletricista = new Eletricista(nome, cpf, rg, disponibilidade, endereco, contato);
		
		
		
		try {
	
		Fachada.getInstance().eletricistaCadastrar(eletricista);
		JOptionPane.showMessageDialog(frmCadastroEletricista, "Cadastro Realizado com sucesso!");
		this.limparCampos();
		
		
		
		} catch (CPFInvalidoException e) {
			JOptionPane.showMessageDialog(frmCadastroEletricista, e.getMessage(), " ERRO ", JOptionPane.ERROR_MESSAGE);
		} catch (EletricistaJaCadastradoEXception e){
			JOptionPane.showMessageDialog(frmCadastroEletricista, e.getMessage(), " ERRO ", JOptionPane.ERROR_MESSAGE);
